...
readLines(system.file("qualify_r/example_success/CMDFile1Out.txt", package="rqualify"))
```
...
readLines(system.file("qualify_r/example_success/CMDFile2Out.txt", package="rqualify"))
```
...
readLines(system.file("qualify_r/example_success/CMDFile3Out.txt", package="rqualify"))
```
...
readLines(system.file("qualify_r/example_success/CMDFile4Out.txt", package="rqualify"))
```
...
readLines(system.file("qualify_r/example_success/CMDFile5Out.txt", package="rqualify"))
```
...
readLines(system.file("qualify_r/example_success/CMDFile6Out.txt", package="rqualify"))
```
...
readLines(system.file("qualify_r/example_success/CMDFile7Out.txt", package="rqualify"))
```
